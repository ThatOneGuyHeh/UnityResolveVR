...
struct Assembly final {
    ...
    [[nodiscard]] auto Get(const std::string &strClass, const std::string &strNamespace = "*", const std::string &strParent = "*") -> Class * {
        for (const auto pClass : classes)
            if (strClass == pClass->name && (strNamespace == "*" || pClass->namespaze == strNamespace) && (strParent == "*" || pClass->parent == strParent))
                return pClass;
        const auto image = UnityResolve::mode_ == Mode::Il2Cpp 
            ? UnityResolve::Invoke<void*>(symbol_il2cpp_assembly_get_image, address)
            : UnityResolve::Invoke<void*>("mono_assembly_get_image", address);
        
        if (!image) return nullptr;
        
        if (mode_ == Mode::Il2Cpp) {
            auto count = Invoke<int>(symbol_il2cpp_image_get_class_count, image);
            for (int i = 0; i < count; i++) {
                auto pClass = Invoke<void*>(symbol_il2cpp_image_get_class, image, i);
                if (!pClass) continue;
                
                auto className = Invoke<const char*>(symbol_il2cpp_class_get_name, pClass);
                auto classNamespace = Invoke<const char*>(symbol_il2cpp_class_get_namespace, pClass);
                
                if (strClass == className && (strNamespace == "*" || classNamespace == strNamespace)) {
                    auto pAClass = new Class();
                    pAClass->address = pClass;
                    pAClass->name = className;
                    if (auto pPClass = Invoke<void*>(symbol_il2cpp_class_get_parent, pClass))
                        pAClass->parent = Invoke<const char*>(symbol_il2cpp_class_get_name, pPClass);
                    pAClass->namespaze = classNamespace;

                    ForeachFields(pAClass, pClass);
                    ForeachMethod(pAClass, pClass);
                    
                    classes.push_back(pAClass);
                    return pAClass;
                }
            }
        }
    ...
    struct Type final {
        ...
        [[nodiscard]] auto GetCSType() const -> void * {
            if (mode_ == Mode::Il2Cpp)
                return Invoke<void *>(symbol_il2cpp_type_get_object, address);
...
auto Get(const std::string &name, const std::vector<std::string> &args = {}) -> RType * {
    if constexpr (std::is_same<RType, Field>::value) {
        ...
        if (mode_ == Mode::Il2Cpp) {
            ...
            void *field;
            do {
                if ((field = Invoke<void*>(symbol_il2cpp_class_get_fields, address, &iter))) {
                    auto fieldName = Invoke<const char*>(symbol_il2cpp_field_get_name, field);
                    if (fieldName == name) {
                        auto pField = new Field();
                        pField->address = field;
                        pField->name = fieldName;
                        pField->type = new Type{.address = Invoke<void*>(symbol_il2cpp_field_get_type, field)};
                        pField->klass = this;
                        pField->offset = Invoke<int>(symbol_il2cpp_field_get_offset, field);
                        pField->static_field = pField->offset <= 0;
                        pField->type->name = Invoke<char*>(symbol_il2cpp_type_get_name, pField->type->address);
                        pField->type->size = -1;
    ...
    if constexpr (std::is_same<RType, Method>::value) {
        ...
        if (mode_ == Mode::Il2Cpp) {
            ...
            void *method;
            do {
                if ((method = Invoke<void*>(symbol_il2cpp_class_get_methods, address, &iter))) {
                    auto methodName = Invoke<const char*>(symbol_il2cpp_method_get_name, method);
                    if (methodName == name) {
                        auto pMethod = new Method();
                        pMethod->address = method;
                        pMethod->name = methodName;
                        pMethod->klass = this;
                        pMethod->return_type = new Type{.address = Invoke<void*>(symbol_il2cpp_method_get_return_type, method)};
                        int fFlags;
                        pMethod->flags = Invoke<int>(symbol_il2cpp_method_get_flags, method, &fFlags);
                        pMethod->static_function = pMethod->flags & 0x10;
                        pMethod->return_type->name = Invoke<char*>(symbol_il2cpp_type_get_name, pMethod->return_type->address);
                        pMethod->return_type->size = -1;
                        pMethod->function = *static_cast<void**>(method);
                        auto argCount = Invoke<int>(symbol_il2cpp_method_get_param_count, method);
                        for (int index = 0; index < argCount; index++) {
                            auto arg = new Method::Arg();
                            arg->name = Invoke<const char*>(symbol_il2cpp_method_get_param_name, method, index);
                            auto pType = new Type();
                            pType->address = Invoke<void*>(symbol_il2cpp_method_get_param, method, index);
                            pType->name = Invoke<char*>(symbol_il2cpp_type_get_name, pType->address);
                            pType->size = -1;
                            arg->pType = pType;
    ...
    return nullptr;
        ...
        [[nodiscard]] auto GetType() -> void * {
            if (objType)
                return objType;
            if (mode_ == Mode::Il2Cpp) {
                const auto pUType = Invoke<void *, void *>(symbol_il2cpp_class_get_type, address);
                objType = Invoke<void *>(symbol_il2cpp_type_get_object, pUType);
                return objType;
            }
        ...
        auto New() -> T * {
            if (mode_ == Mode::Il2Cpp)
                return Invoke<T *, void *>(symbol_il2cpp_object_new, address);
    ...
    struct Field final {
        ...
        auto SetStaticValue(T *value) const -> void {
            if (!static_field)
                return;
            if (mode_ == Mode::Il2Cpp)
                return Invoke<void, void *, T *>(symbol_il2cpp_field_static_set_value, address, value);
            else {
    ...
    struct Method final {
      ...
      public:
        ...
        auto RuntimeInvoke(Obj *obj, Args... args) -> Return {
            ...
            if (mode_ == Mode::Il2Cpp) {
                if constexpr (std::is_void<Return>::value)  {
                    UnityResolve::Invoke<void *>(symbol_il2cpp_runtime_invoke, address, obj, sizeof...(Args) ? argArray : nullptr, nullptr);
                    return;
                } else
                    return Unbox<Return>(Invoke<void *>(symbol_il2cpp_runtime_invoke, address, obj, sizeof...(Args) ? argArray : nullptr, nullptr));
            }
        ...
        T Unbox(void *obj) {
            if (mode_ == Mode::Il2Cpp) {
                return static_cast<T>(Invoke<void *>(symbol_il2cpp_object_unbox, obj));
            } else {
    ...
    static auto ThreadAttach() -> void {
        if (mode_ == Mode::Il2Cpp)
            Invoke<void *>(symbol_il2cpp_thread_attach, pDomain);
        else {
    ...
    static auto ThreadDetach() -> void {
        if (mode_ == Mode::Il2Cpp)
            Invoke<void *>(symbol_il2cpp_thread_detach, pDomain);
        else {
    ...
    static auto Init(void *hmodule, const Mode mode = Mode::Mono) -> void {
        ...
        if (mode_ == Mode::Il2Cpp) {
            pDomain = Invoke<void *>(symbol_il2cpp_domain_get);
            Invoke<void *>(symbol_il2cpp_thread_attach, pDomain);
            //ForeachAssembly();
        } else {
...
#if WINDOWS_MODE || LINUX_MODE || ANDROID_MODE || IOS_MODE /*__cplusplus >= 202002L*/
    static auto DumpToFile(const std::string path) -> void {

        std::string n1 = path;
        if (!n1.empty() && n1.back() != '/' && n1.back() != '\\') {
            n1 += '/';
        }

        #if WINDOWS_MODE
            CreateDirectoryA(n1.c_str(), NULL);
        #elif ANDROID_MODE || LINUX_MODE || IOS_MODE
            mkdir(n1.c_str(), 0755);
        #endif

        std::ofstream io(n1 + "dump.cs", std::fstream::out);
        if (!io)
            return;

        for (const auto &pAssembly : assembly) {
            for (const auto &pClass : pAssembly->classes) {
                io << fmt::format("\tnamespace: {}", pClass->namespaze.empty() ? "" : pClass->namespaze);
                io << "\n";
                io << fmt::format("\tAssembly: {}\n", pAssembly->name.empty() ? "" : pAssembly->name);
                io << fmt::format("\tAssemblyFile: {} \n", pAssembly->file.empty() ? "" : pAssembly->file);
                io << fmt::format("\tclass {}{} ", pClass->name, pClass->parent.empty() ? "" : " : " + pClass->parent);
                io << "{\n\n";
                ...
                for (const auto &pMethod : pClass->methods) {
                    io << fmt::format("\t\t[Flags: {:032b}] [ParamsCount: {:04d}] |RVA: {:#010X}|\n", pMethod->flags, pMethod->args.size(),
                                      reinterpret_cast<std::uint64_t>(pMethod->function) - reinterpret_cast<std::uint64_t>(hmodule_));
                    io << fmt::format("\t\t{}{} {}(", pMethod->static_function ? "static " : "", pMethod->return_type->name, pMethod->name);
                    std::string params{};
                    for (const auto &pArg : pMethod->args)
                        params += fmt::format("{} {}, ", pArg->pType->name, pArg->name);
                    if (!params.empty()) {
                        params.pop_back();
                        params.pop_back();
                    }
        ...
        std::ofstream io2(n1 + "struct.hpp", std::fstream::out);
        if (!io2)
            return;

        for (const auto &pAssembly : assembly) {
            for (const auto &pClass : pAssembly->classes) {
                io2 << fmt::format("\tnamespace: {}", pClass->namespaze.empty() ? "" : pClass->namespaze);
                io2 << "\n";
                io2 << fmt::format("\tAssembly: {}\n", pAssembly->name.empty() ? "" : pAssembly->name);
                io2 << fmt::format("\tAssemblyFile: {} \n", pAssembly->file.empty() ? "" : pAssembly->file);
                io2 << fmt::format("\tstruct {}{} ", pClass->name, pClass->parent.empty() ? "" : " : " + pClass->parent);
                io2 << "{\n\n";
                ...
                next:
                    ...
                    if (field->type->name == "System.String") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::String* {};\n", name);
                    ...
                    if (field->type->name == "UnityEngine.Vector3") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Vector3 {};\n", name);
                    ...
                    if (field->type->name == "UnityEngine.Vector2") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Vector2 {};\n", name);
                    ...
                    if (field->type->name == "UnityEngine.Vector4") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Vector4 {};\n", name);
                    ...
                    if (field->type->name == "UnityEngine.GameObject") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::GameObject* {};\n", name);
                        if (!pClass->fields[i + 1]->static_field && (pClass->fields[i + 1]->offset - field->offset) > sizeof(void *))
                            io2 << fmt::format("\t\tchar {}_[0x{:06X}];\n", name, pClass->fields[i + 1]->offset - field->offset - sizeof(void *));
                        continue;
                    }
                    ...
                    if (field->type->name == "UnityEngine.Transform") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Transform* {};\n", name);
                        if (!pClass->fields[i + 1]->static_field && (pClass->fields[i + 1]->offset - field->offset) > sizeof(void *))
                            io2 << fmt::format("\t\tchar {}_[0x{:06X}];\n", name, pClass->fields[i + 1]->offset - field->offset - sizeof(void *));
                        continue;
                    }
                    ...
                    if (field->type->name == "UnityEngine.Animator") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Animator* {};\n", name);
                        if (!pClass->fields[i + 1]->static_field && (pClass->fields[i + 1]->offset - field->offset) > sizeof(void *))
                            io2 << fmt::format("\t\tchar {}_[0x{:06X}];\n", name, pClass->fields[i + 1]->offset - field->offset - sizeof(void *));
                        continue;
                    }
                    ...
                    if (field->type->name == "UnityEngine.Physics") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Physics* {};\n", name);
                        if (!pClass->fields[i + 1]->static_field && (pClass->fields[i + 1]->offset - field->offset) > sizeof(void *))
                            io2 << fmt::format("\t\tchar {}_[0x{:06X}];\n", name, pClass->fields[i + 1]->offset - field->offset - sizeof(void *));
                        continue;
                    }
                    ...
                    if (field->type->name == "UnityEngine.Component") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Component* {};\n", name);
                        if (!pClass->fields[i + 1]->static_field && (pClass->fields[i + 1]->offset - field->offset) > sizeof(void *))
                            io2 << fmt::format("\t\tchar {}_[0x{:06X}];\n", name, pClass->fields[i + 1]->offset - field->offset - sizeof(void *));
                        continue;
                    }
                    ...
                    if (field->type->name == "UnityEngine.Rect") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Rect {};\n", name);
                    ...
                    if (field->type->name == "UnityEngine.Quaternion") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Quaternion {};\n", name);
                    ...
                    if (field->type->name == "UnityEngine.Color") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Color {};\n", name);
                    ...
                    if (field->type->name == "UnityEngine.Matrix4x4") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Matrix4x4 {};\n", name);
                    ...
                    if (field->type->name == "UnityEngine.Rigidbody") {
                        io2 << fmt::format("\t\tUnityResolve::UnityType::Rigidbody* {};\n", name);
                        if (!pClass->fields[i + 1]->static_field && (pClass->fields[i + 1]->offset - field->offset) > sizeof(void *))
                            io2 << fmt::format("\t\tchar {}_[0x{:06X}];\n", name, pClass->fields[i + 1]->offset - field->offset - sizeof(void *));
                        continue;
                    }
    ...
    static auto InitializeAssembly(const std::string& assemblyName) -> Assembly* {
        std::lock_guard<std::mutex> lock(init_mutex_);
        
        if (mode_ == Mode::Il2Cpp) {
            size_t nrofassemblies = 0;
            const auto assemblies = Invoke<void**>(symbol_il2cpp_domain_get_assemblies, pDomain, &nrofassemblies);
            
            for (size_t i = 0; i < nrofassemblies; i++) {
                const auto ptr = assemblies[i];
                if (!ptr) continue;
                
                const auto image = Invoke<void*>(symbol_il2cpp_assembly_get_image, ptr);
                const char* name = Invoke<const char*>(symbol_il2cpp_image_get_name, image);
                
                if (assemblyName == name || assemblyName + ".dll" == name) {
                    auto assembly = new Assembly{.address = ptr};
                    assembly->file = Invoke<const char*>(symbol_il2cpp_image_get_filename, image);
                    assembly->name = name;
            ...
            // Mono version using non-capturing lambda
            struct CallbackData {
                std::string targetName;
                Assembly* foundAssembly = nullptr;
                std::vector<Assembly*>* outputVector = nullptr;
            };
            
            static CallbackData data;
            data.targetName = assemblyName;
            data.foundAssembly = nullptr;
            data.outputVector = &assembly;
            
            auto callback = [](void* ptr, void* userData) {
                auto data = static_cast<CallbackData*>(userData);
                if (!ptr || data->foundAssembly) return;
                
                void* image = Invoke<void*>("mono_assembly_get_image", ptr);
                const char* name = Invoke<const char*>("mono_image_get_name", image);
                
                if (data->targetName == name || data->targetName + ".dll" == name) {
                    auto assembly = new Assembly{.address = ptr};
                    assembly->file = Invoke<const char*>("mono_image_get_filename", image);
                    assembly->name = name;
                    assembly->name += ".dll";
                    
                    data->outputVector->push_back(assembly);
                    data->foundAssembly = assembly;
                }
            };
            
            Invoke<void, void*, void(*)(void*, void*), void*>("mono_assembly_foreach", pDomain, callback, &data);
            
            return data.foundAssembly;
        }
...
static auto Get(const std::string &strAssembly) -> Assembly * {
    ...
    for (const auto pAssembly : assembly)
        if (pAssembly->name == strAssembly || pAssembly->name == strAssembly + ".dll")
            return pAssembly;
    
    return InitializeAssembly(strAssembly);
}
  ...
  private:
    static auto ForeachAssembly() -> void {
        ...
        if (mode_ == Mode::Il2Cpp) {
            ...
            for (auto i = 0; i < nrofassemblies; i++) {
                ...
                const auto image = Invoke<void *>(symbol_il2cpp_assembly_get_image, ptr);
                assembly->file = Invoke<const char *>(symbol_il2cpp_image_get_filename, image);
                assembly->name = Invoke<const char *>(symbol_il2cpp_image_get_name, image);
                UnityResolve::assembly.push_back(assembly);
    ...
    if (mode_ != Mode::Il2Cpp) return;
    auto count = Invoke<int>(symbol_il2cpp_image_get_class_count, image);
    assembly->classes.reserve(count);
    for (int i = 0; i < count; i++) {
        auto pClass = Invoke<void*>(symbol_il2cpp_image_get_class, image, i);
        if (!pClass) continue;
        auto pAClass = new Class();
        pAClass->address = pClass;
        pAClass->name = Invoke<const char*>(symbol_il2cpp_class_get_name, pClass);
        if (auto pPClass = Invoke<void*>(symbol_il2cpp_class_get_parent, pClass))
            pAClass->parent = Invoke<const char*>(symbol_il2cpp_class_get_name, pPClass);
        pAClass->namespaze = Invoke<const char*>(symbol_il2cpp_class_get_namespace, pClass);
...
static auto ForeachFields(Class *klass, void *pKlass) -> void {
    ...
    void *field;
    do {
        if ((field = Invoke<void*>(symbol_il2cpp_class_get_fields, pKlass, &iter))) {
            auto pField = new Field();
            pField->address = field;
            pField->name = Invoke<const char*>(symbol_il2cpp_field_get_name, field);
            pField->type = new Type{.address = Invoke<void*>(symbol_il2cpp_field_get_type, field)};
            pField->klass = klass;
            pField->offset = Invoke<int>(symbol_il2cpp_field_get_offset, field);
            pField->static_field = pField->offset <= 0;
...
static auto ForeachMethod(Class *klass, void *pKlass) -> void {
    ...
    void *method;
    do {
        if ((method = Invoke<void*>(symbol_il2cpp_class_get_methods, pKlass, &iter))) {
            auto pMethod = new Method();
            pMethod->address = method;
            pMethod->name = Invoke<const char*>(symbol_il2cpp_method_get_name, method);
            pMethod->klass = klass;
            pMethod->return_type = new Type{.address = Invoke<void*>(symbol_il2cpp_method_get_return_type, method)};
            int fFlags;
            pMethod->flags = Invoke<int>(symbol_il2cpp_method_get_flags, method, &fFlags);
      ...
      public:
        ...
        struct String : Object {
            ...
            [[nodiscard]] auto ToString() const -> std::string {
                ...
                std::u16string u16str(reinterpret_cast<const char16_t *>(m_firstChar), m_stringLength);
            ...
            static auto New(const std::string &str) -> String * {
                if (mode_ == Mode::Il2Cpp)
                    return UnityResolve::Invoke<String *, const char *>(symbol_il2cpp_string_new, str.c_str());
        ...
        struct Array : Object {
            ...
            static auto New(const Class *kalss, const std::uintptr_t size) -> Array * {
                if (mode_ == Mode::Il2Cpp)
                    return UnityResolve::Invoke<Array *, void *, std::uintptr_t>(symbol_il2cpp_array_new, kalss->address, size);
        ...
        struct Transform : Component {
            ...
            auto GetLocalScale() -> Vector3 {
                ...
                if (!method)
                    method = Get("UnityEngine.CoreModule.dll")->Get("Transform")->Get<Method>("get_localScale");
                const Vector3 vec3{};
                method->Invoke<void>(this, &vec3);
                return vec3;
            }
